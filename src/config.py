...
def parse_args_llama():
    ...
    parser.add_argument("--max_memory", type=csv_list, default=[45])
    ...
    parser.add_argument('--khop_topk', type=int, default=10)
    parser.add_argument('--khop_topk_e', type=int, default=5)
    parser.add_argument('--khop_cost_e', type=float, default=0.5)
